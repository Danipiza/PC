        ...
        try {
            ...
            while (true) {
        		...
        		while(!puede){
	        		...
	        		comprueba nombre
	        		si no existe puede = true
	        		si existe puede = false
	        		//manda un mensaje, usuario ya conectado vuelve a introducir el nombre:
	        		out  		  
        		...
        		InfoSocket socketCliente = new InfoSocket(sc, in, out);
                ...
                OS = new OyenteServidor(in, out, usuarioC.getID(), tUSERs, tSOCKETs);
