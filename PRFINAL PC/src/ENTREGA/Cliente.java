...
public class Cliente extends Thread {
	...
	private Usuario crearUsuario(String IP) {
		...
		aux = sn.nextLine(); // Salto de linea del entero anterior (numP)
	...
	public void run() {			
		...
		try {			
            ...
            // Termina cuando le pide cerrar conexion al servidor
            // No es una variable compartida, por lo que no hace falta
            // ningun mecanismo de concurrencia
            while(!OC.getFin()) { }
