...
public class OyenteServidor extends Thread{
	...
	public OyenteServidor(DataInputStream in, DataOutputStream out, String IDCliente,
			MonitorLock mPidePeli, MonitorConexion mConexion,
	...
	private void conexionPeerToPeer(InfoSocket cliente, InfoSocket destino) {
		...
		try {
			...
			scAux = new ServerSocket(mConexion.getPuerto());
			Socket sc2 = null;
			...
			new OyentePeerToPeer(cliente.getSocket(), scAux, mConexion,conexion).start();
			sc2 = scAux.accept();
